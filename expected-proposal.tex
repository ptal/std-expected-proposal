...
We follow the approach taken in \cpp{optional}\cite{OptionalRev4}. Moving \cpp{expected<E,T>} do not modify the state (valued or erroneous) of \cpp{expected} and the move semantics is up to \cpp{T} or \cpp{E}.
