...
% Default Constructor
\todo{Should we provide this constructor only if T is default constructible? Do we need to add the enable_if code in the wording or should we inform this as a remark?\\}
\todo{General note about this: should we provide the member/constructor only if the "requires" section is fulfilled? It would avoid a compilation error if the users don't use these features.}
