...
Should \cpp{expected<exception_ptr,T>} be equality comparable using shallow comparision?
...
Should  \cpp{expected<E,T>::map/bind/then} catch the exceptions and propagate them on the result by doing a transfermation from the exception to the error? If yes, how to configure it?
