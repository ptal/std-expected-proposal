...
The function \cpp{mbind} returns the first erroneous expected argument or, if they all contain a value, the result of the ``plus'' operation.
...
%%%%%%%%%%%%%%%%%%%%
\todo{RECODE this using the latest expected API.}
...
\subsection{Monad}
%%%%%%%%%%
\todo{update to latest monad interface or keep it for another proposal?}
